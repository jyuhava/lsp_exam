...
export default function Edit({ exam }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        peraturan: exam.peraturan || '',
        status: exam.status || 'draft',
        use_unit_timer: exam.use_unit_timer || false,
    });
    ...
    return (
        ...
        >
            <Head title={`Edit Exam - ${exam.judul}`} />
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="text-sm text-gray-600">
                                            Dibuat oleh {exam.creator.name} pada {new Date(exam.created_at).toLocaleDateString('id-ID')}
                                        </p>
                                    </div>
                                </div>
                            </div>
